...
let iniciarSesion = () =>{
    ...
    if (usuario && usuario.contrasenia === contraseña) {
        alert("Inicio de sesión exitoso. ¡Bienvenido de nuevo, " + usuario.nombreUsuario + "!");
        console.log("Inicio de sesión exitoso. ¡Bienvenido de nuevo, " + usuario.nombreUsuario + "!");
    } else {
